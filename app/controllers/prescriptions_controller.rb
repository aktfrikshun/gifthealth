...
# Handles prescription CRUD operations and file uploads
class PrescriptionsController < ApplicationController
  before_action :set_prescription, only: %i[show edit update destroy increment_fill decrement_fill]
  ...
  def destroy
    ...
    patient.destroy if patient.prescriptions.empty?
  ...
  def decrement_fill
    if @prescription.fill_count.positive?
  ...
  def upload
    ...
    file = params[:file]
    unless ['text/csv', 'text/plain', 'application/vnd.ms-excel',
            'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'].include?(file.content_type)
