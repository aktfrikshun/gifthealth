...
ActiveRecord::Schema[8.1].define(version: 20_251_130_000_002) do
  ...
  create_table 'prescriptions', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[patient_id drug_name], name: 'index_prescriptions_on_patient_id_and_drug_name', unique: true
